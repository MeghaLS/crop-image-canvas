var imageCropper = {
    ...
    cropImage: function() {
        ...
        console.log((500 - height)/2, (500 - width)/2);
        tempCtx.drawImage(this.image, this.downPointX, this.downPointY, (this.lastPointX - this.downPointX), (this.lastPointY - this.downPointY), (500 - width)/2, (500-height)/2, (this.lastPointX - this.downPointX), (this.lastPointY - this.downPointY));
